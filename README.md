...
Также, по моему мнению, в идеале после нажания кнопки "Взять в работу" у опреатора должна оставаться возможность отмены этого действия (например, кнопка "Отмена"), т.к. никто не застрахован от случайного нажатия.
